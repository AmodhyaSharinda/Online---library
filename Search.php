...
if(isset($_POST['borrow_book']))
{
    ...
    if(mysqli_num_rows($borrow_book) > 0)
    {
        ...
        $insert_book = mysqli_query($conn, "INSERT INTO borrow_book (user_name, Book_name, quantity, image, due_date) VALUES ('$_SESSION[user_name]', '$book_name', '$book_qty', '$book_image', '$due_date')");
...
else if(isset($_POST['reserve_book']))
{
    ...
    if(mysqli_num_rows($reserve_book) > 0)
    {
        ...
        $insert_book = mysqli_query($conn, "INSERT INTO reserve_book (user_name, Book_name, quantity, image, due_date) VALUES ('$_SESSION[user_name]', '$book_name', '$book_qty', '$book_image', '$due_date')");
