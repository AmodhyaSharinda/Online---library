...
<div class="container">
  ...
  <?php
    ...
    $select = mysqli_query($conn, "SELECT * FROM user_db WHERE user_type = 'admin' ");
  ...
  <div class="books-display">
    ...
    <table class="books-display-table">
      ...
      <tr>
        ...
        <td>
          <a href="Admin_admins.php?delete=<?php echo $row['user_id']; ?>" class="btn"> <i class="fas fa-trash"></i> remove </a>
        </td>
      </tr>
