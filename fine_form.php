<?php
  ...
  if(isset($_POST['fine'])){
    ...
    $insert = "INSERT INTO payment (user_name, payment_type, Amount) VALUES ('$name', '$pay_type', '$Amount')";
...
<div class="container">
  <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
    <div class="row">
        <h3 class="title">Fine Payment Form</h3>
    ...
    <input type="submit" class="submit-btn" value="proceed to payment" name="fine">
  </form>
</div>