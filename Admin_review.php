...
<div class="container">
  ...
  <?php
    ...
    $select = mysqli_query($conn, "SELECT * FROM reviews")
  ...
  <div class="books-display">
    ...
    <table class="books-display-table">
      ...
      <tr>
        ...
        <td>
           <a href="Admin_review_read.php?edit=<?php echo $row['review_id']; ?>" class="btn"> <i class="fas fa-edit"></i> read </a>
          <a href="Admin_review.php?delete=<?php echo $row['review_id']; ?>" class="btn"> <i class="fas fa-trash"></i> remove </a>
        </td>
      </tr>
